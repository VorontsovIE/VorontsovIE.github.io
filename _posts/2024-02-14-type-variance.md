...
Очевидно, стихотворение является текстом (мы здесь упростим реальности и опустим тот факт, что стихотворение может быть и не текстом). Обозначим такое отношение типов стрелочкой: `Poem ← Text` и будем говорить, что тип `Poem` унаследован от типа `Text`.<br/>
...
Поэтому мне очень понравилось, как то же самое элегантно [решено](https://kotlinlang.org/docs/generics.html) в Kotlin!
