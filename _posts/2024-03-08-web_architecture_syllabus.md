...
Сначала скажу о том, чем этот курс НЕ является. Это не быстрое погружение в веб-программирование для чайников. Но [такой курс](https://vorontsovie.github.io/web-programming-syllabus/) у меня тоже есть.
